...
import ADFSLogo from "@/public/active-directory-access-control.svg";
...
function handleSocialLogin({
  ...
  oAuthURL.searchParams.append("identity_provider", identityProviderName); // The name of the identity provider configured in Cognito
    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <Button
          ...
          type="button"
          className="w-full"
          onClick={() => handleSocialLogin({ identityProviderName: "Google" })}
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path
        ...
        <Button
          ...
          type="button"
          className="w-full"
          onClick={() => handleSocialLogin({ identityProviderName: "ADFS" })}
        >
          <Image
            src={ADFSLogo}
            alt="Image"
            width={50}
            height={50}
            className="w-7 h-7 dark:brightness-[0.2] dark:grayscale"
          />
          <span className="sr-only">Login with AD</span>
        </Button>
      </div>
    </>
  );
